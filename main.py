...
bot_token = "6834346878:AAHGXvu7_tOgFYgXlWGOqaVWExTNaNpe2rU"
start_msg = "Bienvenidos al bot"
key = ""
ghost = "https://revgacetaestudiantil.sld.cu/index.php/gme"
guser = "erickees"
gpass = "Erickees87*"
grepo = 257
zips = 14
...
async def techdev_bot(event):
	...
	if '/start' == text and isuser(user_id):
	    ...
	    if start_msg == "":
	        ...
	        await bot.send_message(user_id, f"<b><-- BitZero [PkP] --></b>\n\n{start_msg}\n\n<i>Acerca de:</i> /about\n<i>Creado por:</i> @erickees", parse_mode="HTML")
